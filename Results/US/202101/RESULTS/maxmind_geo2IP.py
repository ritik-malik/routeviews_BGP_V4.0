...
# A script to geolocate all the prefixes (stored in form of html from the pipeline output)
...
#
############### GLOBAL VARS ##################
output_file = 'Maxmind_Geo2IP_US_202102.csv'
input_folder = 'GRAPHS'
############### GLOBAL VARS ##################
# 
...
csv_file.write('ISP_ASN, IP, check1, check2, check3, state\n')
    ...
    for fname in f:
        if fname.endswith('.html'):
            ...
            if subnet == '24':
                ...
                txt = ISP_ASN + ', ' + IP + '/' + subnet + ', ' + city1 + ', ' + city2 + ', ' + state1 
                csv_file.write(txt)
                csv_file.write('\n')
                ...
                txt = ISP_ASN + ', ' + IP + '/' + subnet + ', ' + city1 + ', ' + city2 + ', ' + city3 + ', ' + state1 
                csv_file.write(txt)
                csv_file.write('\n')
